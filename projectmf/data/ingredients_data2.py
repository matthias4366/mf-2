...
ingredient_dict_list = [
    {
        ...
        'buy_here_link': 
            'https://www.get-grocery.com/en/dal-lentils-beans/'
            '112-trs-red-kidney-beans-rajma-1-5017689005092.html',
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/'
            'facts/legumes-and-legume-products/4301/2',
        'calories': 337,
        'carbohydrates': 61.3,
        'fat': 1.1,
    ...
    },
    {
        ...
        'buy_here_link': 'https://www.getnow.com/'
                         'Themenwelten/Sommer-Sonne-Salate/'
                         'Rapso-100-reines-Rapsoel-750ml.'
                         'html?userInput=raps&ignoreForCache'
                         '[]=userInput&queryFromSuggest=true'
                         '&ignoreForCache[]=queryFromSuggest',
        'source_nutritional_information_link': 
    ...
    },
    {
        ...
        'buy_here_link':
            'https://www.get-grocery.com/en/rice-noodles/'
            '323-tilda-broken-basmati-rice-5011157330402.html',
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/'
            'facts/cereal-grains-and-pasta/5812/2',
        'calories': 365,
        'carbohydrates': 79.9,
        'fat': 0.7,
    ...
    },
    {
        ...
        'buy_here_link':
            ...
            'Speisekammer/Konserven/Gemuese-Sauerkonserven/'
            'Mutti-Passierte-italienische-Tomaten-700g.'
            'html?userInput=mutti%20tom&ignoreForCache[]'
            '=userInput&queryFromSuggest=true&ignoreForCache[]'
            '=queryFromSuggest',
        'source_nutritional_information_link': None,
        'calories': 38.0,
        'carbohydrates': 9.0,
        ...
        'protein': 1.7,
        # Vitamins
        # vitamin a taken from
        # https://nutritiondata.self.com/facts/
        # vegetables-and-vegetable-products/2960/2
        # and converted based on *0.3 from
    ...
    },
    {
        ...
        'buy_here_link':
            'https://www.getnow.com/index.php?'
            'cl=details&cnid=269&actcontrol=details'
            '&anid=430628601819020001&redirected=1',
        'source_nutritional_information_link':
            'https://www.getnow.com/'
            'index.php?cl=details&cnid=269&actcontrol='
            'details&anid=430628601819020001&redirected=1',
        'calories': 22.4,
        'carbohydrates': 4.8,
        'fat': None,
    ...
    },
    {
        ...
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/'
            'facts/vegetables-and-vegetable-products/2482/2',
        'calories': 22,
        'carbohydrates': 3.3,
        'fat': 0.3,
        'alpha_linoleic_acid': None,
    ...
    },
    {
        ...
        'buy_here_link':
            'https://www.amazon.de/'
            'gp/product/B0799MYYNC/ref=ppx_'
            'yo_dt_b_search_asin_title?ie=UTF8&psc=1',
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/'
            'facts/nut-and-seed-products/3138/2',
        'calories': 654,
        'carbohydrates': 13.7,
        'fat': 65.2,
    ...
    },
    {
        ...
        'buy_here_link':
            'https://www.getnow.com/'
            'index.php?cl=details&cnid='
            '193&actcontrol=details&anid=430628603914340001&redirected=1',
        # macros from package, micros from nutrition data
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/facts/'
            'cereal-grains-and-pasta/5783/2',
        'calories': 348,
        'carbohydrates': 64,
        'fat': 2.5,
    ...
    },
    {
        ...
        'buy_here_link':
            'https://de.myprotein.com/sporternahrung/'
            'erbsenprotein-isolat/10530136.html',
        'source_nutritional_information_link':
            'https://de.myprotein.com/'
            'sporternahrung/erbsenprotein-isolat/10530136.html',
        'calories': 357,
        'carbohydrates': 3.0,
        'fat': 5.0,
        'alpha_linoleic_acid': None,
    ...
    },
    {
        ...
        'buy_here_link':
            'https://www.getnow.com/'
            'index.php?cl=details&cnid=999&actcontrol=d'
            'etails&anid=430628601335060001&redirected=1',
        'source_nutritional_information_link':
            'https://www.getnow.com/'
            'index.php?cl=details&cnid=999&actcontrol='
            'details&anid=430628601335060001&redirected=1',
        'calories': 69,
        'carbohydrates': 6.3,
        'fat': 4,
        'alpha_linoleic_acid': None,
    ...
    },
    {
        ...
        'buy_here_link':
            ...
            'details&anid=430628601335060001&redirected=1',
        'source_nutritional_information_link':
            'https://www.getnow.com/index.php?cl='
            'details&cnid=999&actcontrol='
            'details&anid=430628601335060001&redirected=1',
        'calories': 69,
        'carbohydrates': 6.3,
        'fat': 4,
    ...
    },
    {
        ...
        'amount_in_package': 1000,
        'buy_here_link':
            'https://www.getnow.com/Tiefkuehl/Gemuese-Kraeuter-Obst/'
            'Gemuese-Pilze/Metro-Chef-Blattspinat-Portionen-1kg.'
            'html?ffCheckoutTrackData%5Bcampaign%5D=be'
            'e2c58c-29ba-4b4e-a778-51a67f8aba0f&listtype=s'
            'earch&searchparam=spinat',
        'source_nutritional_information_link':
            'https://nutritiondata.self.com/facts/'
            'vegetables-and-vegetable-products/2626/2',
        'calories': 23.0,
        'carbohydrates': 3.6,
        'fat': 0.4,
    ...
    },
    {
        ...
        'chloride': None,  # 'default_unit': 'gram'
        'buy_here_link':
            'https://www.bulkpowders.de/'
            'complete-multivitamin-komplex-de.html',
        'source_nutritional_information_link':
            'https://www.bulkpowders.de/'
            'complete-multivitamin-komplex-de.html',
        'is_public': True,
    },
    {
        ...
        'buy_here_link':
            'https://www.amazon.de/'
            'dp/B01NCIZG7B/?tag=glv-21&ascsubtag='
            '3770aba8-0eac-417e-9c01-448e295cce7a',
        'source_nutritional_information_link':
            'https://www.amazon.de/dp/B01NCIZG7B/?tag=glv-21&as'
            'csubtag=3770aba8-0eac-417e-9c01-448e295cce7a',
        'is_public': True,
    },
    {
        ...
        'calcium': 21100,  # 'default_unit': 'milligram'
...

    {
        ...
        'is_public': True,
        'reference_amount': 100,  # default: 100 g
        'price_per_reference_amount': 0.733,
        'calories': 333,  # 'default_unit': 'kcal'
        'carbohydrates': 0.1,  # 'default_unit': 'gram'
        'fat': 12,  # 'default_unit': 'gram'
        'protein': 37,  # 'default_unit': 'gram'
        'linoleic_acid': None,  # 'default_unit': 'gram'
        'alpha_linoleic_acid': None,  # 'default_unit': 'gram'
        # Vitamin A unit conversion:
        # Vitamin A: 1 IU is the biological equivalent of 0.3 mcg retinol,
