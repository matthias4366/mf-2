...
class FullDayOfEatingTest(FunctionalTestWithUserLoggedIn):
    ...
    def test_calculation_result_is_negative_error(self):
        """
        This test tests whether the CalculationResultIsNegativeError is
        displayed properly at the proper time.
        If the linear equation system is set up badly, it is possible to get
        negative results. Since negative results are not actionable because
        they are not physically implementable, an errror message is shown to
        the user.
        The test consists of setting up the full day of eating in a way to
        force negative results and to check whether the correct error is
        displayed correctly.
        """
        ...
        nutrient_profile_name = 'High calories low protein'
        ...
        self.assertNotIn('calories', error_message_text)
