...
def calculate_total_price_fulldayofeating(
    ...
    total_price_currency = \
        specificingredient_dict_list[0][
            'raw_ingredient']['currency_of_price_per_reference_amount']
    ...
    for specificingredient_dict_k in specificingredient_dict_list:
        ...
        price_is_valid = \
            (specificingredient_dict_k[
                 'raw_ingredient']['price_per_reference_amount'] is not None) \
            and (specificingredient_dict_k[
        ...
        if price_is_valid:
            total_price = total_price +\
                ...
                * specificingredient_dict_k[
                              'raw_ingredient']['price_per_reference_amount']
