# Generated by Django 2.2.1 on 2019-11-04 16:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nutrient_target', models.CharField(choices=[('calories', 'calories'), ('carbohydrates', 'carbohydrates'), ('fat', 'fat'), ('protein', 'protein'), ('linoleic_acid', 'linoleic_acid'), ('alpha_linoleic_acid', 'alpha_linoleic_acid'), ('vitamin_a', 'vitamin_a'), ('vitamin_c', 'vitamin_c'), ('vitamin_d', 'vitamin_d'), ('vitamin_e', 'vitamin_e'), ('vitamin_k', 'vitamin_k'), ('thiamin', 'thiamin'), ('riboflavin', 'riboflavin'), ('niacin', 'niacin'), ('vitamin_b6', 'vitamin_b6'), ('folate', 'folate'), ('vitamin_b12', 'vitamin_b12'), ('pantothenic_acid', 'pantothenic_acid'), ('biotin', 'biotin'), ('choline', 'choline'), ('calcium', 'calcium'), ('chromium', 'chromium'), ('copper', 'copper'), ('fluoride', 'fluoride'), ('iodine', 'iodine'), ('iron', 'iron'), ('magnesium', 'magnesium'), ('manganese', 'manganese'), ('molybdenum', 'molybdenum'), ('phosphorus', 'phosphorus'), ('selenium', 'selenium'), ('zinc', 'zinc'), ('potassium', 'potassium'), ('sodium', 'sodium'), ('chloride', 'chloride')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_calories_unit', models.CharField(choices=[('kcal', 'kcal')], default='kcal', max_length=100)),
                ('max_carbohydrates', models.FloatField(blank=True, null=True)),
                ('max_carbohydrates_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_fat', models.FloatField(blank=True, null=True)),
                ('max_fat_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_protein', models.FloatField(blank=True, null=True)),
                ('max_protein_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_linoleic_acid', models.FloatField(blank=True, null=True)),
                ('max_linoleic_acid_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_alpha_linoleic_acid', models.FloatField(blank=True, null=True)),
                ('max_alpha_linoleic_acid_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_vitamin_a', models.FloatField(blank=True, null=True)),
                ('max_vitamin_a_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_vitamin_c', models.FloatField(blank=True, null=True)),
                ('max_vitamin_c_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_vitamin_d', models.FloatField(blank=True, null=True)),
                ('max_vitamin_d_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_vitamin_e', models.FloatField(blank=True, null=True)),
                ('max_vitamin_e_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_vitamin_k', models.FloatField(blank=True, null=True)),
                ('max_vitamin_k_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_thiamin', models.FloatField(blank=True, null=True)),
                ('max_thiamin_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_riboflavin', models.FloatField(blank=True, null=True)),
                ('max_riboflavin_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_niacin', models.FloatField(blank=True, null=True)),
                ('max_niacin_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_vitamin_b6', models.FloatField(blank=True, null=True)),
                ('max_vitamin_b6_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_folate', models.FloatField(blank=True, null=True)),
                ('max_folate_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_vitamin_b12', models.FloatField(blank=True, null=True)),
                ('max_vitamin_b12_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_pantothenic_acid', models.FloatField(blank=True, null=True)),
                ('max_pantothenic_acid_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_biotin', models.FloatField(blank=True, null=True)),
                ('max_biotin_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_choline', models.FloatField(blank=True, null=True)),
                ('max_choline_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_calcium', models.FloatField(blank=True, null=True)),
                ('max_calcium_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_chromium', models.FloatField(blank=True, null=True)),
                ('max_chromium_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_copper', models.FloatField(blank=True, null=True)),
                ('max_copper_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_fluoride', models.FloatField(blank=True, null=True)),
                ('max_fluoride_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_iodine', models.FloatField(blank=True, null=True)),
                ('max_iodine_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_iron', models.FloatField(blank=True, null=True)),
                ('max_iron_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_magnesium', models.FloatField(blank=True, null=True)),
                ('max_magnesium_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_manganese', models.FloatField(blank=True, null=True)),
                ('max_manganese_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_molybdenum', models.FloatField(blank=True, null=True)),
                ('max_molybdenum_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_phosphorus', models.FloatField(blank=True, null=True)),
                ('max_phosphorus_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_selenium', models.FloatField(blank=True, null=True)),
                ('max_selenium_unit', models.CharField(choices=[('microgram', 'microgram')], default='microgram', max_length=100)),
                ('max_zinc', models.FloatField(blank=True, null=True)),
                ('max_zinc_unit', models.CharField(choices=[('milligram', 'milligram')], default='milligram', max_length=100)),
                ('max_potassium', models.FloatField(blank=True, null=True)),
                ('max_potassium_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_sodium', models.FloatField(blank=True, null=True)),
                ('max_sodium_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('max_chloride', models.FloatField(blank=True, null=True)),
                ('max_chloride_unit', models.CharField(choices=[('gram', 'gram')], default='gram', max_length=100)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['name'],
